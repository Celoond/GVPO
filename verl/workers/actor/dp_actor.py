...
from verl.trainer.ppo.core_algos import agg_loss, compute_policy_loss, kl_penalty, gvpo_compute_policy_loss
...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto):
        ...
        select_keys = ["responses", "input_ids", "attention_mask", "position_ids", "old_log_probs", "advantages","advantage_weight"]
        ...
        for epoch in range(self.config.ppo_epochs):
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    advantage_weight=data["advantage_weight"]
                    ...
                    # pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower = gvpo_compute_policy_loss(
