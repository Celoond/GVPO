...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None):
    ...
    elif data_source in ["lighteval/MATH", "DigitalLearningGmbH/MATH-lighteval", "my_math"]:
        from . import math
    ...
    # elif data_source == "my_math":
    #     from . import mymath
        
    #     res = mymath.compute_score(solution_str, ground_truth)
    elif data_source in [
        "numina_aops_forum",
