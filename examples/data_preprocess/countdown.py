...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/gemini/space/r1_tool/data')
    ...
    raw_dataset = load_dataset('parquet', data_files='/gemini/space/r1_tool/data/train-00000-of-00001.parquet')
